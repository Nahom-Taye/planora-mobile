...
const messageKeys = new Map<string, TranslationKey>([
  ...
  ['Write a reflection before saving.', 'validation.reflectionBody'],
  ['Use 8,000 characters or fewer.', 'validation.reflectionLength'],
  ['Choose a valid reflection date.', 'validation.reflectionDate'],
  ['This reflection scope does not use an identifier.', 'validation.reflectionScope'],
  ['Choose an available mood label.', 'validation.reflectionMood'],
  ['A reflection already exists for this period.', 'validation.reflectionDuplicate'],
  ...
  ['Planora could not refresh insights. Saved local data is unchanged.', 'errors.insightsRefresh'],
  ['This reflection changed before your update was saved. Refresh and try again.', 'errors.reflectionRevision'],
  ['That reflection change could not be saved. Refresh and try again.', 'errors.reflectionSave'],
  ['The reflection is no longer available.', 'errors.reflectionUnavailable'],

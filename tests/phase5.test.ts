...
test('language, capacity, and Planner view preferences persist revision-safely', async () => {
  const settings: AppSettings = {
    ...metadata('settings-1'), profileId: 'profile-1', themePreference: 'system', defaultTab: 'today', planningDayStartsAt: toLocalTime('06:00'), languagePreference: 'system', dailyPlanningCapacityMinutes: 480, plannerView: 'day', onboardingVersion: 1, onboardingCompletedAt: instant,
  };
...
test('Phase 5 rows map every settings, block, and recurrence field', () => {
  ...
  const settings: AppSettings = {
    ...metadata('settings-1'), profileId: 'profile-1', themePreference: 'dark', defaultTab: 'planner', planningDayStartsAt: toLocalTime('07:00'), languagePreference: 'fr', dailyPlanningCapacityMinutes: 390, plannerView: 'week', onboardingVersion: 1, onboardingCompletedAt: instant,
  };
